# FNLLA Web Trademark Notice

## Brand ownership

`FNLLA`, `FNLLA Web`, `FNLLA PHP` and related product branding are names associated with TechAyo LTD (techayo.co.uk).
...
- to say that a project is built with FNLLA Web
...
- present a fork or derivative as the official FNLLA Web project
...
- publish a modified framework under the FNLLA Web product identity as though it were the official maintained release
